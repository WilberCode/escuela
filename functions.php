...
if( function_exists('acf_add_options_page') ) {
    ...
    acf_add_options_sub_page(array(
		'page_title' 	=> 'Información general de los Cursos',
		'menu_title'	=> 'Campos generales de los Cursos',
...
if( function_exists('acf_add_options_page') ) {
    ...
    acf_add_options_sub_page(array(
		'page_title' 	=> 'Información general de los Diplomas',
		'menu_title'	=> 'Campos generales de los Diplomas',
...
if( function_exists('acf_add_options_page') ) {
    ...
    acf_add_options_sub_page(array(
		'page_title' 	=> 'Información general de los Congresos',
		'menu_title'	=> 'Campos generales de los Congresos',
...
if( function_exists('acf_add_options_page') ) {
    ...
    acf_add_options_sub_page(array(
		'page_title' 	=> 'Información general de las Páginas',
		'menu_title'	=> 'Campos generales de las Páginas',
