   ...
   <div class="max-w-6xl m-auto  shadow">  
        ...
        <div  class="py-4 px-6" >
            ...
            <button class="bg-blue-600 text-white px-6 py-3 rounded " >Registrarse Aqui</button> 
             ...
             <div class="w-full shadow rounded flex  overflow-hidden mt-4">
                <div class="w-1/2 bg-white " > 
                    <img src="https://i.stack.imgur.com/KZFfe.png" alt="">
                </div>
                <div class="w-1/2 bg-white p-6" > 
                    Lorem ipsum dolor sit amet, consectetur adipisicing elit. Dolore doloribus error quos nemo laudantium, placeat consequuntur debitis rem inventore qui unde sed animi itaque rerum eveniet et dolor labore omnis.
                </div>
            </div> 
        </div>
   </div>     
