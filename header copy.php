...
<header class="header "  > 
    <div class="header-wrap container py-4  text-dark"> 
        ...
        <div  class="flex justify-between space-x-2 maxmd:pt-2 pb-2 md:pb-4  z-40 "  id="navbar-sticky-mobile">
        ...
        <div class=" z-30  " id="navbar-sticky"  > 
             <div  class="  sticky-content flex  justify-center md:justify-between items-center space-x-2   w-full h-[60px]   " >  
