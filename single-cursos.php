   ...
   <div class="container m-auto">
       <div class="grid grid-cols-1 lg:grid-cols-3 gap-5 mt-6 lg:mt-4"> 
           <div class="main lg:col-span-2   "> 
            ...
            <style>
               .tabs::before{
                  background-color:<?php echo $bg_current ?>; background:linear-gradient(90deg, <?php echo $bg_current ?> 0%,<?php echo $bg_current.'a6' ?> 100%);  
               }
            </style>
            <ul class="tabs " >
                              ...
                              <?php  foreach( $curso_docentes as $curso_docente ) { ?>	 
                                      <div class="teacher grid grid-col-1 lg:grid-cols-6 lg:gap-4  mt-5  ">
                                          <div class=" teacher-avatar lg:col-span-1  inline-flex  nowrap items-center justify-center lg:justify-between  ">  
                                             <div class="">
                                                   <div class="text-center text-white   w-full  lg:w-52 px-4 py-6 relative z-[4]  card-decorator  "  style="background:linear-gradient(11deg, <?php echo $bg_current;?>  0%,<?php echo $bg_current.'a6';?>  100%)">
                        ...
                        <div class="note " style="background-color:<?php echo $bg_current.'0a';?>" >
                           ...
                           <div class="md:flex "  >
                              <div class="  md:w-3/5 maxmd:pb-4  "  >
                                    <h4>Deposita</h4>
                                    <div class="mt-2 " ><span class="font-SignikaNegative text-h5 text-dark "  > A nombre de: </span> ESCUELA DE GERENCIA Y GESTIÓN </div>
                                    <div  ><span class="font-SignikaNegative text-h5 text-dark "  > RUC: </span> 20510129921 </div>
                              ...
                              <div  class="  md:w-2/5 flex items-center md:justify-center border-t md:border-l md:border-t-0 pt-4" styles="border-color:var(--bg-current-gradient)" > 
                                 <div class="md:px-4">
                                    <a class="font-SignikaNegative text-h5 text-dark hover:underline _blank " target="_blank" href="https://www.rnp.gob.pe/Constancia/RNP_Constancia/default_Todos.asp?RUC=20510129921"  > RNP Vigente </a> 
